namespace Xilium.CefGlue
{
    ...
    using CodeDesk.Desktop.CefGlue;
    ...
    public unsafe abstract class CefWindowInfo
    {
        ...
        {
            switch (AppBuilder.Platform)
            {
                case RuntimePlatform.Windows: return new CefWindowInfoWindowsImpl();
                case RuntimePlatform.Linux: return new CefWindowInfoLinuxImpl();
                case RuntimePlatform.MacOS: return new CefWindowInfoMacImpl();
        ...
        internal static CefWindowInfo FromNative(cef_window_info_t* ptr)
        {
            switch (AppBuilder.Platform)
            {
                case RuntimePlatform.Windows: return new CefWindowInfoWindowsImpl(ptr);
                case RuntimePlatform.Linux: return new CefWindowInfoLinuxImpl(ptr);
                case RuntimePlatform.MacOS: return new CefWindowInfoMacImpl(ptr);
                default: throw new NotSupportedException();
            }
        }
